---
layout: post
title: Use the Otari Gateway with OpenCode
description: |
...
external_url: https://blog.mozilla.ai/use-the-otari-gateway-with-opencode/
---

[This is an article that I contributed to for blog.mozilla.ai]({{ page.external_url }})
